...
const SAMPLE_POSTS = [
  {
    ...
    location: 'Town Square, Main St',
    description: 'Weekly market with local produce, baked goods, and live music on the north lawn.',
    contact: '',
    createdAt: Date.now() - 1000 * 60 * 60 * 24 * 2,
  },
  {
    id: 'seed-2',
    title: 'Volunteers needed: creek cleanup',
    type: 'volunteer',
    date: nextWeekday(0),
    time: '9:00 AM',
    location: 'Willow Creek trailhead',
    description: 'Gloves and bags provided. Bring water and closed-toe shoes. About 2 hours of light work.',
    contact: 'creek-cleanup@example.org',
    createdAt: Date.now() - 1000 * 60 * 60 * 24 * 4,
  },
  {
    id: 'seed-3',
    title: 'Public comment: new bike lane proposal',
    type: 'call-to-action',
    date: nextWeekday(3),
    time: '6:30 PM',
    location: 'City Hall, Council Chambers',
    description: 'The council is reviewing the Elm Street bike lane plan. Residents can speak for up to 3 minutes.',
    contact: '',
    createdAt: Date.now() - 1000 * 60 * 60 * 24,
  },
  {
    id: 'seed-4',
    title: 'Water main work on Birch Ave',
    type: 'notice',
    date: nextWeekday(2),
    time: 'All day',
    location: 'Birch Ave, between 3rd and 5th',
    description: 'Expect single-lane closures while crews repair a water main. Water service is not affected.',
    contact: '',
